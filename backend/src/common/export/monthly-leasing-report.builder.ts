  ...
  return new Promise((resolve, reject) => {
    ...
    y = drawTable(
      ...
      [
        ...
        { key: 'c112', header: '112', width: 36, align: 'right' },
        { key: 'c113', header: '113', width: 36, align: 'right' },
        { key: 'c122', header: '122', width: 36, align: 'right' },
        { key: 'c123', header: '123', width: 36, align: 'right' },
