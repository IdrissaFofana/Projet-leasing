...
export class CampaignsService {
  ...
  async export(mois: string, format: 'xlsx' | 'pdf') {
    ...
    const columns = [
      ...
      { key: 'c112', header: 'Noir G', width: 9, align: 'right' as const },
      { key: 'c113', header: 'Noir P', width: 9, align: 'right' as const },
      { key: 'c122', header: 'Couleur G', width: 9, align: 'right' as const },
      { key: 'c123', header: 'Couleur P', width: 9, align: 'right' as const },
